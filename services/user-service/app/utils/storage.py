...
Same pattern as the Phase 1 monolith's storage layer -- every route talks
to data through these functions, never the filesystem directly. Here it's
also the mechanism that makes data ownership real: this service can only
ever see users.json, nothing else.
"""
